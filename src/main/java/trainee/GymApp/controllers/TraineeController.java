...
public class TraineeController {
    ...
    @GetMapping("/{username}")
    public ResponseEntity<TraineeFullDTO> getTrainee(@PathVariable(name = "username") String username, @RequestHeader(name = "password") String password) {
    ...
    public ResponseEntity<HttpStatus> delete(@PathVariable(name = "username") String username, @RequestHeader(name = "password") String password) {
        facade.deleteTrainee(username, password);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @GetMapping("/{username}/not-trainers")
    public ResponseEntity<Set<TrainerForSet>> notAssignedTrainers(@PathVariable(name = "username") String username, @RequestHeader(name = "password") String password) {
        Set<Trainer> set = facade.getNotAssignedTrainers(username, password);
    ...
    public ResponseEntity<List<TrainingsForResponse>> getTrainings(@PathVariable(name = "username") String username, @RequestHeader(name = "password") String password, @RequestParam(name = "from", required = false) @DateTimeFormat(iso = ISO.DATE) LocalDate from,
        ...
        List<Training> list = facade.getTraineeTrainingsWithCriteria(username, password, from, to, trainerName, trainingType);
